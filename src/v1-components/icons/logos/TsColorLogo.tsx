...
export const TsColorLogo = ({ ...props }: BrandLogoProps) => {
  return (
    <svg
      // Use a default viewBox or extract from SVG if needed
      viewBox="0 0 32 32" // Adjust viewBox to match TS logo aspect ratio
