...
} from '@/v1-components/icons/logos';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="space-y-6 mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 items-center flex-wrap">
              <div className="w-8 h-8">
                <TsNeutralLogo color="#FF6B6B" />
              </div>
              <div className="w-8 h-8">
                <ReactLogo color="#4ECDC4" />
              </div>
              <div className="w-8 h-8">
                <TailwindLogo color="#96CEB4" />
              </div>
              <div className="w-8 h-8">
                <FirebaseLogo color="#FFEEAD" />
              </div>
              <div className="w-8 h-8">
                <FigmaLogo color="#D4A5A5" />
              </div>
              <div className="w-8 h-8">
                <FramerLogo color="#9B59B6" />
              </div>
              <div className="w-8 h-8">
                <LottieLogo color="#2ECC71" />
              </div>
              <div className="w-8 h-8">
                <NextjsLogo color="#F39C12" />
              </div>
              <div className="w-8 h-8">
                <WhopLogoBrandmarkOrangeLogo color="#E74C3C" />
              </div>
            </div>
          </div>
        ...
        <section className="space-y-6 mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 items-center">
              <Badge size="sm" leftIcon={Github}>
                Github
              </Badge>
              <Badge size="md" leftIcon={Star}>
                Star
              </Badge>
              <Badge size="lg" leftIcon={ChevronRight}>
                Next
              </Badge>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 items-center">
              <Badge size="sm" rightIcon={Github}>
                Github
              </Badge>
              <Badge size="md" rightIcon={Star}>
                Star
              </Badge>
              <Badge size="lg" rightIcon={ChevronRight}>
                Next
              </Badge>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 items-center">
              ...
              <Badge size="md" variant="outline" leftIcon={Star}>
                Star
              </Badge>
              <Badge size="lg" variant="outline" rightIcon={ChevronRight}>
                Next
              </Badge>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 items-center">
              <Badge size="md" leftIcon={LOCATION_LOTTIE}>
                Location
              </Badge>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 items-center flex-wrap">
              <Badge rounded="none" leftIcon={Star}>
                With Icon None
              </Badge>
              <Badge rounded="sm" leftIcon={Star}>
                With Icon SM
              </Badge>
              <Badge rounded="md" leftIcon={Star}>
                With Icon MD
              </Badge>
              <Badge rounded="lg" leftIcon={Star}>
                With Icon LG
              </Badge>
              <Badge rounded="full" leftIcon={Star}>
                With Icon Full
              </Badge>
            </div>
            <div className="flex gap-4 items-center">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-6 items-center">
              <Badge variant="surface" leftIcon={Star}>
                Surface Badge
              </Badge>
              <Badge variant="surface" rightIcon={ChevronRight}>
                Next Step
              </Badge>
              <Badge variant="surface" leftIcon={Github} rightIcon={ChevronRight}>
                View Code
              </Badge>
            </div>
            <div className="flex gap-6 items-center">
              <Badge size="sm" variant="surface" leftIcon={Star}>
                Small
              </Badge>
              <Badge size="md" variant="surface" leftIcon={Star}>
                Medium
              </Badge>
              <Badge size="lg" variant="surface" leftIcon={Star}>
                Large
              </Badge>
            </div>
          </div>
