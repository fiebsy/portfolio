...
const plainPhrase = "I build clean, intuitive dashboards and real-time tools that make data useful.";

const supportContent = {
  short: "",
  medium: " I focus on creating engaging user experiences.", // Note the leading space
  long: ( // Use JSX for the version with links
    <React.Fragment>
      {' '}At <a href="https://www.whop.com" target="_blank" rel="noopener noreferrer" className=" underline">Whop</a>, I created an interactive leaderboard displayed in ~90% of user sessions. Before that, I built financial and social insight dashboards for <a href="https://www.stride.zone" target="_blank" rel="noopener noreferrer" className="underline">Stride</a>.
    </React.Fragment>
  )
};
